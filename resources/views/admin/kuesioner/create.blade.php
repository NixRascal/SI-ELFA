    ...
    <form action="{{ route('dashboard.kuesioner.store') }}" method="POST" id="formKuesioner">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button type="button" onclick="tambahPertanyaan()" class="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="space-y-3">
                        <button type="submit" class="w-full inline-flex items-center justify-center rounded-md bg-indigo-600 px-4 py-3 text-sm font-medium text-white hover:bg-indigo-700">
                            <i class="fas fa-save mr-2"></i>
                            Simpan Kuesioner
                        </button>
                        <a href="{{ route('dashboard.kuesioner.index') }}" class="w-full inline-flex items-center justify-center rounded-md bg-white px-4 py-3 text-sm font-medium text-gray-700 border border-gray-300 hover:bg-gray-50">
...
document.getElementById('icon').addEventListener('change', function() {
    ...
    if (iconClass) {
        preview.innerHTML = `<i class="${iconClass} text-indigo-600"></i>`;
    } else {
    ...
    const pertanyaanHTML = `
        <div class="pertanyaan-item bg-gray-50 rounded-lg border border-gray-200 p-5" data-index="${pertanyaanCount}">
            <div class="flex items-start justify-between mb-4">
                ...
                <button type="button" onclick="hapusPertanyaan(this)" class="text-red-600 hover:text-red-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2 opsi-jawaban-container" style="display: none;">
                    ...
                    <button type="button" onclick="tambahOpsi(${pertanyaanCount})" class="mt-2 text-sm text-indigo-600 hover:text-indigo-800">

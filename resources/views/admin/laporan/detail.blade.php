    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                ...
                <a href="{{ route('dashboard.laporan.print', $kuesioner->id) }}" 
                    target="_blank"
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <p class="mt-1">
                        <span class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-sm font-medium text-gray-800 capitalize">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900">{{ $responden->count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-bold text-gray-900">{{ $responden->count() * $kuesioner->pertanyaan->count() }}</p>
                </div>
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">

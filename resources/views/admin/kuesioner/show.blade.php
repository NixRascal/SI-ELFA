...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('dashboard.laporan.hasil', $kuesioner->id) }}"
                        class="inline-flex items-center px-4 py-2 border border-blue-600 rounded-md shadow-sm text-sm font-medium text-blue-600 bg-white hover:bg-blue-50 cursor-pointer">
        ...
        <!-- Daftar Responden -->
        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl mt-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">
